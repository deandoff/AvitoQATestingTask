...
#### 6.1: Создание с неккоректным значением поля sellerID
**Шаги:**
...
#### 6.2: Создание с некорректым значением поля price
**Шаги:**
...
**Предварительные условия:**
1. Существует объявление с некотором UUID, например `df3ff6f1-75a2-4d77-b0dc-744ed5fc175a`.
